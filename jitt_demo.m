   ...
   orig_syn=0; 
    ...
    % [basic] jitter, and tabulate synchrony counts
        ...
        for k=1:num_jitter
            ...
            n2_jitt=sort(n2_jitt);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%          
            if n2_jitt(1)==0;
               n2_jitt = n2_jitt(2:end);
            end
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % [interval] jitter, and tabulate synchrony counts
        ...
        for k=1:num_jitter
            ...
            n1_jitt=n1;
            %max( n1-n1_jitt )
            n2_jitt_int=(jitter_width)*floor( n2/(jitter_width) ) + (jitter_width)*(randi( 2,1,length(n2) )-1);
            n2_jitt_int=sort(n2_jitt_int);
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
             if n2_jitt_int(1)==0;
               n2_jitt_int = n2_jitt_int(2:end);
            end

 %%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % compute synchrony
            s=synch_compute( n1_jitt,n2_jitt_int);
